...
function Header({ sidebarCollapsed, onMobileMenuClick }) {
  ...
  return (
    <div
      className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-4 fixed top-0 right-0 left-0 z-20 transition-all duration-300 lg:px-6"
      style={{
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Search */}
        <div className="flex items-center gap-2 bg-gray-100 rounded-lg px-3 py-2 w-40 sm:w-64 md:w-80">
        ...
        <div className="flex items-center gap-2">
          ...
          {user?.photoURL ? (
            <img
              src={user.photoURL}
              alt="Profile"
              className="w-8 h-8 md:w-9 md:h-9 rounded-full border-2 border-purple-200"
            />
          ) : (
            <div className="w-8 h-8 md:w-9 md:h-9 rounded-full bg-purple-500 flex items-center justify-center text-white text-sm font-bold border-2 border-purple-200">
