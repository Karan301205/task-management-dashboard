function TaskCard({ task }) {
  ...
  return (
    <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-100 mb-3 cursor-grab active:cursor-grabbing">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex -space-x-2">
          {[0, 1, 2].map((i) => (
            <div
              key={i}
              className={`w-6 h-6 rounded-full ${avatarColors[i]} border-2 border-white`}
            ></div>
          ))}
        </div>
